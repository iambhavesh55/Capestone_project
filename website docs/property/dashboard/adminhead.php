        ...
        <nav class="navbar navbar-expand-sm navbar-default"style="background-color:#070719;color:#fff">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav"style="background-color:#070719;color:#fff">
                    <li class="active">
                        <a href="dashboard.php"><i class="menu-icon fa fa-laptop"></i>Main Dashboard</a>
                    </li>
                    <li class="menu-title">Admin Dashboard</li>
                    <li class="menu-item-has-children ">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-money"></i>Commissions</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-money"></i><a href="earnings.php"> Total Earnings</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children ">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-product-hunt"></i><a href="allproducts.php">All Products</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="soldproducts.php">Sold Products</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children ">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-product-hunt"></i>Users</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-product-hunt"></i><a href="adduser.php">Add User</a></li>
                            <li><i class="menu-icon fa fa-product-hunt"></i><a href="alluser.php">All Users</a></li>
                        </ul>
                    </li>
                    
                    <li class="menu-item-has-children ">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-product-hunt"></i>Subscribers</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-product-hunt"></i><a href="subscribe.php">My Subscribers</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
